...
//                 const res = await fetch("http://localhost:8000/api/my-documents", {
//                     headers: {
...
//                                 <tbody>
//                                     {documents.map((doc, i) => (
//                                         <tr key={doc._id} className="border-t border-gray-100 hover:bg-gray-50 transition">
...
//                                                     >
//                                                         <button className="block w-full cursor-pointer text-left px-3 py-2 text-sm hover:bg-gray-100">
//                                                             Download
//                                                         </button>
//                                                         <button className="block w-full cursor-pointer text-left px-3 py-2 text-sm text-red-600 hover:bg-gray-100">
//                                                             Delete
//                                                         </button>
//                                                     </div>
//                                                 )}
...
export default function MyDocumentsPage() {
    ...
    const handleDownload = async (documentId: string, filename: string) => {
        try {
            ...
            const response = await fetch(
                `http://localhost:8000/api/my-documents/${documentId}/download`,
                {
                    method: "GET",
                    headers: {
                        "Authorization": `Bearer ${token}`,
    ...
    const handleDelete = async (documentId: string) => {
        try {
            ...
            const response = await fetch(
                `http://localhost:8000/api/my-documents/${documentId}`,
                {
                    method: "DELETE",
                    headers: {
                        "Authorization": `Bearer ${token}`,
