...
//                         <SidebarItem icon={<FaHome />} label="Home" active mobile />
//                         <SidebarItem icon={<FaFileUpload />} label="Upload documents" mobile />
//                         <SidebarItem icon={<FaFolderOpen />} label="My documents" mobile />
//                         <SidebarItem icon={<FaSyncAlt />} label="Regenerate comparison" mobile />
//                     </nav>
//                 </div>
