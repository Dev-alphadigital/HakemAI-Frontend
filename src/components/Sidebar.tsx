            ...
            >
                <div>
                    ...
                    <nav className="mt-4 space-y-1 px-3">
                        ...
                        <SidebarItem
                            icon={<FaBuilding />}
                            label="Company team access"
                            active={pathname === "/dashboard/company-team-access"}
                            mobile
                            onClick={() => {
                                router.push("/dashboard/company-team-access");
                                setMobileOpen(false);
                            }}
                        />
                    </nav>
                ...
                <div>
                    <nav className="mt-3 flex flex-col space-y-2">
                        ...
                        <SidebarItem
                            ...
                            label="Company team access"
                            active={pathname === "/dashboard/company-team-access"}
                            onClick={() => router.push("/dashboard/company-team-access")}
                        />
                    </nav>
                </div>
...
/* ================================
 ✅ Sidebar Item with Lock Support
================================ */
function SidebarItem({
    ...
    return (
        <div
            onClick={handleClick}
            className={`
      flex items-center gap-3 px-5 py-3 rounded-md mx-2
      transition-all duration-200
      ${locked ? "cursor-not-allowed opacity-40" : "cursor-pointer"}
      ${active && !locked ? "bg-[#fdc431] text-black font-semibold" : ""}
      ${!locked && !active ? "hover:bg-[#066e61] text-white" : ""}
      ...
      `}
        >
            ...
            {locked && (
                <span className="ml-auto bg-white text-[#04786b] text-xs px-2 py-1 rounded">
                    Locked
                </span>
            )}
        </div>
