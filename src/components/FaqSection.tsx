...
export default function FaqSection() {
    ...
    const faqs = [
        ...
        {
            question: 'What is the "Strategic Memo"?',
            answer:
                "The Strategic Memo is a professional, one-page executive summary of the comparison results. Instead of printing all the raw data, it provides: A clear top recommendation. A high-level financial snapshot. A breakdown of the top contenders' strengths and weaknesses. It's designed to be a client-ready document that you can use to present your findings and justify your recommendation.",
        },
        {
