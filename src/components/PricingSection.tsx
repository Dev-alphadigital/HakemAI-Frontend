...
//                     <div
//                         key={index}
//                         className={`relative rounded-xl border ${plan.borderColor} bg-white p-8 shadow-sm`}
//                     >
//                         {/* Early Adopter Discount Tag */}
...
//                         {/* Slashed Price */}
//                         <p className="text-gray-500 font-semibold mb-1 line-through text-lg">{plan.slashedPrice}</p>

//                         {/* Price */}
//                         <p
//                             className="text-3xl font-bold mb-1"
//                             dangerouslySetInnerHTML={{
//                                 __html: `${plan.pricePrefix
//                                     ? plan.pricePrefix + " "
//                                     : ""
//                                     }${plan.price}`,
//                             }}
...
//                                     <span className="text-[#0B8A62] text-lg mt-[2px]">
//                                         ✓
//                                     </span>
//                                     <span
//                                         dangerouslySetInnerHTML={{
...
//                                 {/* Slashed Price */}
//                                 <p className="text-gray-500 font-semibold mb-1 line-through">{plan.slashedPrice}</p>
            ...
            <div className="hidden md:grid max-w-6xl mx-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {plans.map((plan, index) => (
                    ...
                    >
                        ...
                        <button className="w-full mt-auto border border-[#04786b] text-[#04786b] font-semibold py-2 rounded-md hover:bg-[#e8f5f2] transition">
                            Get started
                        </button>
                    </div>
                ))}
